    ...
    <>
      {!isMobile ? (
        <a 
          ...
          className="inline-block border-none bg-none outline-none font-inherit cursor-pointer p-0 m-0 focus:outline-2 focus:outline-offset-2 focus:outline-green-500"
        >
          <div className="fixed-component">
            <div className="flex items-center justify-center gap-0 px-4 py-4 relative z-20 transition-all duration-300 hover:gap-2 hover:justify-start">
              <svg 
                viewBox="0 0 24 24" 
                fill="currentColor" 
                className="whatsapp-icon transition-transform duration-300 flex-shrink-0"
                width="20" 
                height="20"
              >
              ...
              <span className="font-semibold text-sm max-w-0 overflow-hidden transition-all duration-300 opacity-0 ml-0 hover:opacity-100 hover:ml-1 hover:max-w-xs">BeeSupport</span>
            </div>
