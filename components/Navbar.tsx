      ...
      <Drawer open={openMenu} onClose={() => setOpenMenu(false)} anchor="right" transitionDuration={400}>
        ...
        >
          <List sx={{ mt: 2 }}>
            ...
            <ListItemButton component="a" href={APP_URL} target="_blank" rel="noopener noreferrer" sx={{ borderRadius: 3, background: '#fff200', py: 2, '&:hover': { background: '#ffed4e', transform: 'scale(1.02)' }, transition: 'all 0.3s', boxShadow: 2 }}>
